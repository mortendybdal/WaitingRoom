...
module.exports = function (app) {
    ...
    //============Clinic Routes==============
    app.get('/api/clinics', clinics.getClinics);
    app.get('/api/clinics/:clinic_id', clinics.getClinic);
    app.put('/api/clinics', clinics.updateClinic);
    app.post('/api/clinics', clinics.createClinic);
    ...
    app.get('/api/users/:clinic_id', auth.ensureAuthenticated, users.getUsersByClinic);
