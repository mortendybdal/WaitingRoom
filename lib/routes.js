...
module.exports = function (app) {
    ...
    app.get('/api/schemes/:scheme_id/patient/:patient_id', auth.ensureAuthenticated(['User','Editor','Admin']), schemes.getSchemeWithAnswers);
    ...
    app.get('/api/clinics/:clinic_id/users', auth.ensureAuthenticated(['Admin']), users.getUsersByClinic);
    app.put('/api/clinics/:clinic_id/users', auth.ensureAuthenticated(['Admin'] ), users.updateUserByClinic);
