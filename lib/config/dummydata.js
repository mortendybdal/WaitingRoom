...
var scheme = ["Mave Onde", "Øjnbetændelse", "Ørebetændrelse", "Halssmerter", "Ledsmerter", "Ondt i ryggen"],
                ...
                _.forEach(scheme, function (scheme_title) {
                    ...
                    Scheme.create({Title: scheme_title}, function (err, scheme) {
                        _.forEach(stepTitles, function (step_title) {
                            Step.create({Title: step_title, Scheme_id: scheme._id}, function (err, step) {
